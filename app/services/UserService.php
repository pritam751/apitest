...
/**
 * Class : UserService
 * Purpose : To perform all operations regarding user[contains business logic for constructing response regarding to api]. 
 * @example newUser(), doLogin(), getUsers(), followUnfollowUser(), forgotPassword()
 */
...
class UserService extends ApiBaseService
{
    ...
    public function forgotPassword($email) 
    {
        ...
        if ($userData) {
            ...
            $dataForView = ['name' => $userData[0]['name'], 'password' => $password];
            $emails[] = $userData[0]['email'];
